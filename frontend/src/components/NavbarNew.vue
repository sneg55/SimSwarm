  ...
  >
    <div class="max-w-6xl mx-auto px-4 md:px-8 flex items-center justify-between">
      ...
      <div class="flex items-center gap-7">
        <a :href="DOCS_URL" target="_blank" rel="noopener" class="nav-link">Docs</a>
        ...
        <template v-else-if="configStore.demoMode">
          <!-- Read-only demo: signups disabled, so point at the source instead -->
          <a :href="GITHUB_URL" target="_blank" rel="noopener" class="nav-link">
        ...
        <template v-else>
          ...
          <router-link
            ...
            class="px-5 py-2 rounded-lg text-sm font-semibold text-white
                   ...
                   glow-cyan transition-[transform,box-shadow] duration-250 ease-spring

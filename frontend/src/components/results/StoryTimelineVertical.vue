        ...
        >
          ...
          <div v-if="i % 2 === 0" class="pr-2 flex justify-end">
            ...
            >
              ...
              <div class="text-[15px] font-semibold text-mist-foam mb-1 leading-6 line-clamp-2 pb-1">{{ m.title }}</div>
              <div v-if="m.detail" class="text-[13px] text-mist-drift leading-[22px] line-clamp-2 pb-1">{{ m.detail }}</div>
            </div>
          </div>
          <div v-else></div>

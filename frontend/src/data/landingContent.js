...
export const INSIGHTS = [
  { label: 'Key Finding', color: '#FF6B6B', text: 'Public sentiment shifts negative within 48 hours of the announcement, driven by the regulatory agent cluster.' },
  ...
  { label: 'Confidence', color: '#A78BFA', text: 'Overall confidence high · sentiment trending negative · coalition stable', mono: true },
]

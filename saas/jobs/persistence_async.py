"""Async DB write helpers for SimulationJob — for use in async contexts."""
...
from saas.jobs.persistence_engine import _get_worker_session_factory
...
def _update_job_metadata(
    job_id: int,
    pod_id: str,
    provision_seconds: int | None = None,
    pipeline_seconds: int | None = None,
) -> None:

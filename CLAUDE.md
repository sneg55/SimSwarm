...
FishCloud — a fully managed SaaS wrapping the open-source MiroShark swarm intelligence engine. Users buy credits, upload a seed document, set a prediction goal, and get a report + chat replay + entity graph.

...
real result instead of a refund.
"""
...
@pytest.mark.asyncio
async def test_circuit_breaker_exhausts_budget_then_refunds(temporal_env):
    """If both pods trip the circuit breaker, workflow gives up after one
    retry, refunds, and propagates the failure."""
    from saas.workflows.sim_workflow import SimulationWorkflow

...
SAMPLE_LOG: list[ActionRecord] = [
    ...
    ActionRecord(
        ...
        action_type="follow",
        platform="twitter",
        action_args={"agent_id": "agent-alpha"},
    ...
    ActionRecord(
        ...
        action_type="follow",
        platform="twitter",
        action_args={"agent_id": "agent-gamma"},
    ...
    ActionRecord(
        ...
        action_type="follow",
        platform="reddit",
        action_args={"agent_id": "agent-beta"},
        timestamp="2026-04-08T10:21:00Z",
        success=True,
    ),
    # Round 3 — failed follow (unknown target) must not appear in the graph
    ActionRecord(
        round_num=3,
        agent_id="agent-delta",
        agent_name="Dave",
        action_type="follow",
        platform="twitter",
        action_args={"agent_id": "agent-ghost"},
        timestamp="2026-04-08T10:21:30Z",
        success=False,
    ),
